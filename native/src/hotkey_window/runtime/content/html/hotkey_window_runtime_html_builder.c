...
WCHAR* kbo_build_webview_hub_html(void)
{
    ...
    kbo_window_text_appendf(&buffer,
        ...
        ".identity{display:flex;align-items:center;gap:10px;min-width:0}.logo{width:46px;height:46px;object-fit:contain;filter:drop-shadow(0 1px 1px rgba(0,0,0,.65))}.brand{font-family:var(--ui-font);font-weight:800;font-size:%dpx;color:#f5f1e7;line-height:1}.date{font-family:var(--ui-font);font-size:%dpx;font-weight:800;color:#cfd5d6;margin-top:4px;text-transform:uppercase;letter-spacing:0}.brandBlock{min-width:0}.captainPlate{height:22px;display:flex;align-items:center;justify-content:flex-end;gap:7px;margin-left:auto;min-width:0;max-width:220px;padding:0;border:0;border-radius:0;background:transparent;box-shadow:none;overflow:hidden;opacity:.88}.captainName{display:block;min-width:0;color:#d8d8d8;font-size:12px;font-weight:800;line-height:18px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.captainMark{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;border:1px solid rgba(214,164,75,.62);border-radius:2px;background:rgba(214,164,75,.10);color:#d6a44b;font-family:var(--ui-font);font-size:11px;font-weight:900;line-height:18px;flex:none}.captainBadge{display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;margin-left:0;padding:0;border:1px solid rgba(214,164,75,.56);border-radius:2px;background:rgba(214,164,75,.10);color:#d6a44b;font-family:var(--ui-font);font-size:10px;font-weight:900;line-height:16px;vertical-align:middle;box-shadow:none}"
