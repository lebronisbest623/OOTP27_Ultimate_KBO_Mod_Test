...
void kbo_webview_append_roster_sort_script(KboWindowTextBuffer* buffer)
{
    ...
    kbo_window_text_appendf(
        ...
        "var customScrollers=document.querySelectorAll('.rosterTableWrap,.settingsCard,.modBuildCard');for(var r=0;r<customScrollers.length;r++){installOotpScrollbar(customScrollers[r]);}"
