...
#define KBO_INTL_ESTABLISHED_FA_NON_ASIAN_STARTER_SCORE_CAP KBO_FOREIGN_FA_NON_ASIAN_QUALITY_CAP_DEFAULT_STARTER
#define KBO_INTL_ESTABLISHED_FA_NON_ASIAN_BULLPEN_SCORE_CAP KBO_FOREIGN_FA_NON_ASIAN_QUALITY_CAP_DEFAULT_BULLPEN
#define KBO_INTL_ESTABLISHED_FA_NON_ASIAN_UNKNOWN_PITCHER_SCORE_CAP KBO_FOREIGN_FA_NON_ASIAN_QUALITY_CAP_DEFAULT_PITCHER
#define KBO_INTL_ESTABLISHED_FA_NON_ASIAN_HITTER_SCORE_CAP KBO_FOREIGN_FA_NON_ASIAN_QUALITY_CAP_DEFAULT_HITTER
#define KBO_INTL_ESTABLISHED_FA_NON_ASIAN_CATCHER_SCORE_CAP KBO_FOREIGN_FA_NON_ASIAN_QUALITY_CAP_DEFAULT_CATCHER
