...
static int kbo_foreign_retention_guard_stamp_signed_state(
    uint8_t* player,
    uint8_t* team,
    const KboForeignRetentionGuardRecord* rec)
{
...
static int kbo_foreign_retention_guard_clean_signed_holder(
    uint8_t* player,
    uint8_t* team,
    const KboForeignRetentionGuardRecord* rec)
{
...
static int kbo_foreign_retention_guard_player_repairable(
    uint8_t* player,
    const KboForeignRetentionGuardRecord* rec)
{
...
static void kbo_foreign_retention_guard_log_cleaned(
    const char* source,
    const KboForeignRetentionGuardRecord* rec,
    uint8_t* player,
    uint32_t today,
...
static void kbo_foreign_retention_guard_log_restored(
    const char* source,
    const KboForeignRetentionGuardRecord* rec,
    uint8_t* player,
    uint32_t today,
