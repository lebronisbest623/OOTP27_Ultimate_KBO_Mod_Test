...
/* ---- native/src/foreign/signability/foreign_fa_block_state.inc ---- */
/* Recent foreign FA block cache. Included from native/KBOFix.c. */
...
static void kbo_record_recent_foreign_offer_allow(uint32_t player_id, uint32_t requester_team_id, uint32_t today)
{
...
static void kbo_record_recent_custom_foreign_policy_allow(uint32_t player_id, uint32_t requester_team_id, uint32_t today)
{
    kbo_record_recent_foreign_allow(
...
int kbo_recent_foreign_offer_block_matches(uint32_t player_id, uint32_t today, uint32_t* out_requester_team_id, uint32_t* out_holder_team_id)
{
