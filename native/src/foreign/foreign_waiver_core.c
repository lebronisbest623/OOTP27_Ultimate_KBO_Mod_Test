...
/* ---- native/src/foreign/foreign_waiver_results.inc ---- */
/* Foreign waiver result-summary generation and announcement records. Included from native/src/foreign_waiver_ai.inc. */
