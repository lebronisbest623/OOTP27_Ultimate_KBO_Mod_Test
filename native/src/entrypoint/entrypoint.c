...
#include "../allstar/allstar_flags.h"
#include "../allstar/allstar_league_context/allstar_league_context.h"
#include "../allstar/allstar_team_patch.h"
...
#include "../custom_events/custom_event_monitor.h"
#include "../fa_requalification/fa_requalification.h"
#include "../fa_salary_snapshot/fa_salary_snapshot_parts/salary_snapshot_phase_events.h"
#include "../fa_salary_snapshot/fa_salary_snapshot_parts/salary_snapshot_thread.h"
#include "../foreign/foreign_waiver_core.h"
#include "../foreign/foreign_waiver_policy.h"
#include "../foreign/injury/foreign_injury.h"
#include "../foreign/intl_established_fa_postscan/intl_established_fa_postscan.h"
...
#include "../patch_installers/patch_installers_allstar_events.h"
#include "../patch_installers/patch_installers_allstar_settings.h"
#include "../patch_installers/patch_installers_allstar_static.h"
#include "../patch_installers/patch_installers_foreign_ai_fa_fallback.h"
#include "../patch_installers/patch_installers_foreign_ai_fa_status.h"
#include "../patch_installers/patch_installers_foreign_callup_limits.h"
#include "../patch_installers/patch_installers_foreign_counts.h"
#include "../patch_installers/patch_installers_foreign_signability_entry.h"
#include "../patch_installers/patch_installers_foreign_signing_branch.h"
#include "../patch_installers/patch_installers_foreign_submit_offer_probe.h"
#include "../patch_installers/patch_installers_foreign_trade_check.h"
#include "../patch_installers/patch_installers_intl_established_fa.h"
#include "../patch_installers/patch_installers_military.h"
#include "../patch_installers/patch_installers_season_phase_probe.h"
...
static int kbo_current_save_has_required_roster_marker(const char* source, int log_detail)
{
    char save_path[MAX_PATH] = {0};
    ...
    if (marked) {
        append_logf(
            "KBO runtime marker guard passed source=%s save=%s description=%s",
            source != NULL ? source : "",
            save_path,
            description_path);
        return 1;
...
static void install_kbo_full_runtime_after_roster_marker(HINSTANCE instance)
{
    ...
    if (!read_kbo_localappdata_flag_file("disable_kbo_no_minor_contract_experimental_patch.txt")) {
    ...
    if (!read_kbo_localappdata_flag_file("disable_kbo_fa_salary_opening_day_snapshot.txt")) {
        start_kbo_fa_salary_snapshot_phase_event_thread();
        if (!read_kbo_localappdata_flag_file("disable_kbo_fa_salary_opening_day_phase_hook.txt")) {
            install_kbo_season_phase_opening_day_snapshot_hooks();
        } else {
            append_log_line("KBO FA salary opening-day phase hook disabled: kbo_flags.json disable_kbo_fa_salary_opening_day_phase_hook is true");
        }
