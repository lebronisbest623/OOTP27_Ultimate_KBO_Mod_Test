...
$NativeAliasSourcePath = Join-Path $RepoRoot "native\src\core\core_flags\keys\runtime_flag_aliases.generated.c"
$NativeAliasHeaderPath = Join-Path $RepoRoot "native\src\core\core_flags\keys\runtime_flag_aliases.generated.h"
...
Write-Utf8NoBom $NativeAliasSourcePath $NativeAliasLines
Write-Utf8NoBom $NativeAliasHeaderPath $NativeAliasHeaderLines

Write-Host "Generated $CSharpPath"
Write-Host "Generated $NativeUiSourcePath"
Write-Host "Generated $NativeUiHeaderPath"
Write-Host "Generated $NativeAliasSourcePath"
Write-Host "Generated $NativeAliasHeaderPath"
